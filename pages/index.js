...
export default function PaginaInicial() {
    // const username = 'murillom';
    const [username, setUsername] = React.useState('');
    const roteamento = useRouter();
    const imagemInicial = "https://www.personality-database.com/profile_images/26662.png";
              ...
              <TextField
                ...
                textFieldColors={{
                  neutral: {
                    ...
                    mainColorHighlight: appConfig.transparente.buttonRed,
